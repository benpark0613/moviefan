	...
	<div class="d-flex justify-content-center my-3">
		<ul class="nav nav-tabs">
			<li class="nav-item" style="width: 250px;">
				<a class="nav-link link-dark active text-center" aria-current="page" href="findid">아이디 찾기</a>
			</li>
			<li class="nav-item" style="width: 250px;">
				<a class="nav-link link-dark text-center" aria-current="page" href="findpassword">비밀번호 찾기</a>
			</li>
		</ul>
	</div>
	<div class="row mt-3">
		<form class="" method="post" action="findid">
			<div class="col-6 offset-3">
				...
				<div class="row mb-5">
					<div class="d-grid gap-1 col-6 mx-auto">
						<button type="button" class="btn btn-light btn-lg" id="confirm">아이디 찾기</button>
					</div>
				</div>
			</div>
		</form>
