	...
	<div class="d-flex justify-content-center">
		<form class="border p-3 bg-white w-50" method="post" action="registerform">
			...
			<div class="d-flex justify-content-center mb-2">
				<textarea class="form-control bg-white" style="height: 150px;" readonly="readonly">제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</textarea>
			...
			<div class="d-flex justify-content-center mb-4">
				<textarea class="form-control bg-white" style="height: 150px;" readonly="readonly">개인정보처리방침
