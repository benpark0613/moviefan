 ...
 *
 */
public class PaginationMyAccount {
	 ...
	 */
	public PaginationMyAccount(String pageNo, int totalRecords) {
	 ...
	 */
	public PaginationMyAccount(String pageNo, int totalRecords, int rows) {
